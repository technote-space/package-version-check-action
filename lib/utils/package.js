...
exports.getBranch = (logger, context) => __awaiter(void 0, void 0, void 0, function* () {
    const tagName = github_action_helper_1.Utils.getTagName(context);
    if (tagName) {
    ...
    return github_action_helper_1.Utils.getBranch(context);
});
exports.commit = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const branch = yield exports.getBranch(logger, context);
    if (false === branch) {
        return false;
    }
    const helper = new github_action_helper_1.ApiHelper(logger, { branch: branch, refForUpdate: `heads/${branch}`, suppressBPError: true });
