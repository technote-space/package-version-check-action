...
const helper = new github_action_helper_1.ApiHelper(logger);
...
exports.commit = (octokit, context) => __awaiter(void 0, void 0, void 0, function* () { return yield helper.commit(misc_1.getPackageDir(), misc_1.getCommitMessage(), [misc_1.getPackageFileName()], octokit, context); });
