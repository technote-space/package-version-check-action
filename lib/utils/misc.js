...
const { getWorkspace, escapeRegExp } = github_action_helper_1.Utils;
...
exports.getPackageVersionToUpdate = (tagVersion) => normalizeVersion(exports.isTestTag(tagVersion) ? exports.getTestTag(tagVersion) : tagVersion);
exports.isRequiredUpdate = (packageVersion, tagVersion) => normalizeVersion(packageVersion) !== exports.getPackageVersionToUpdate(tagVersion);
