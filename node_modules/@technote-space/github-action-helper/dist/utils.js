...
exports.getArrayInput = (name, required = false) => exports.uniqueArray(core_1.getInput(name, { required }).split(/\r?\n/).reduce((acc, line) => acc.concat(line.split(',')).filter(item => item).map(item => item.trim()), []));
